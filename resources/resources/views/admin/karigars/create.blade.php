...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.karigar.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.karigars.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alternate_mobile_no') ? 'is-invalid' : '' }}" type="number" name="alternate_mobile_no" id="alternate_mobile_no" value="{{ old('alternate_mobile_no', '') }}" step="1">
          ...
          <!--   <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_anniversary') ? 'is-invalid' : '' }}" type="text" name="date_of_anniversary" id="date_of_anniversary" value="{{ old('date_of_anniversary') }}">
