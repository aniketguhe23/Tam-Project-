    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('karigar_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.karigars.index") }}" class="nav-link {{ request()->is("admin/karigars") || request()->is("admin/karigars/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-user-tag">

                            </i>
                            <p>
                                {{ trans('cruds.karigar.title') }}
                            </p>
                        </a>
                    </li>
                @endcan
                @can('product_master_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/product-categories*") ? "menu-open" : "" }} {{ request()->is("admin/products*") ? "menu-open" : "" }} {{ request()->is("admin/design-numbers*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @endcan
                            @can('design_number_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.design-numbers.index") }}" class="nav-link {{ request()->is("admin/design-numbers") || request()->is("admin/design-numbers/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon far fa-object-group">

                                        </i>
                                        <p>
                                            {{ trans('cruds.designNumber.title') }}
                                        </p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                      <a href="{{ url("admin/design-share-show") }}" class="nav-link {{ request()->is("admin/design-share-show") || request()->is("admin/design-share-show/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon far fa-object-group">
                ...
                @endcan
                @can('order_master_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/customer-orders*") ? "menu-open" : "" }} {{ request()->is("admin/karigar-orders*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                            <i class="fa-fw nav-icon fas fa-shopping-cart">

                            </i>
                            <p>
                                {{ trans('cruds.orderMaster.title') }}
                                <i class="right fa fa-fw fa-angle-left nav-icon"></i>
                            </p>
                        </a>
                        <ul class="nav nav-treeview">
                            @can('customer_order_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.customer-orders.index") }}" class="nav-link {{ request()->is("admin/customer-orders") || request()->is("admin/customer-orders/*") ? "active" : "" }}">
                            ...
                            @endcan
                            @can('karigar_order_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.karigar-orders.index") }}" class="nav-link {{ request()->is("admin/karigar-orders") || request()->is("admin/karigar-orders/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fab fa-first-order-alt">

                                        </i>
                                        <p>
                                            {{ trans('cruds.karigarOrder.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
