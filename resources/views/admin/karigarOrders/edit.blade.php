...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.karigarOrder.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.karigar-orders.update", [$karigarOrder->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('karigar') ? 'is-invalid' : '' }}" name="karigar_id" id="karigar_id" required>
                    @foreach($karigars as $id => $karigar)
                        <option value="{{ $id }}" {{ (old('karigar_id') ? old('karigar_id') : $karigarOrder->karigar->id ?? '') == $id ? 'selected' : '' }}>{{ $karigar }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('product_design') ? 'is-invalid' : '' }}" name="product_design_id" id="product_design_id" required>
                    @foreach($product_designs as $id => $product_design)
                        <option value="{{ $id }}" {{ (old('product_design_id') ? old('product_design_id') : $karigarOrder->product_design->id ?? '') == $id ? 'selected' : '' }}>{{ $product_design }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('per_piece_weight') ? 'is-invalid' : '' }}" type="text" name="per_piece_weight" id="per_piece_weight" value="{{ old('per_piece_weight', $karigarOrder->per_piece_weight) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_weight') ? 'is-invalid' : '' }}" type="text" name="total_weight" id="total_weight" value="{{ old('total_weight', $karigarOrder->total_weight) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('purity') ? 'is-invalid' : '' }}" type="text" name="purity" id="purity" value="{{ old('purity', $karigarOrder->purity) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pieces') ? 'is-invalid' : '' }}" type="text" name="pieces" id="pieces" value="{{ old('pieces', $karigarOrder->pieces) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('size') ? 'is-invalid' : '' }}" type="text" name="size" id="size" value="{{ old('size', $karigarOrder->size) }}" required>
                @if($errors->has('size'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('delivery_date') ? 'is-invalid' : '' }}" type="text" name="delivery_date" id="delivery_date" value="{{ old('delivery_date', $karigarOrder->delivery_date) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remark') ? 'is-invalid' : '' }}" name="remark" id="remark">{{ old('remark', $karigarOrder->remark) }}</textarea>
