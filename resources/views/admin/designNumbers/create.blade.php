...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.designNumber.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.design-numbers.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('design_number') ? 'is-invalid' : '' }}" type="text" name="design_number" id="design_number" value="{{ old('design_number', '') }}" required>
